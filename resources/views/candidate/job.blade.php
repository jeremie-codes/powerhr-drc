...
<div class="dashboard-main-body nft-page">
    <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
        <h6 class="fw-semibold mb-0">Liste d'offres</h6>
                ...
                <table class="table bordered-table mb-0">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                {{ $job->jobOffer->title ?? 'Offre supprimée' }}
                            </td>

                            <td>
                                {{ $job->jobOffer->company_name ?? '-' }}
                            </td>
                            ...
                            {{-- Action --}}
                            <td class="text-center">
                                @if ($job->status === 'soumise')
                                    <form method="POST"
                                        action="{{ route('candidate.demande.annuler', $job) }}"
