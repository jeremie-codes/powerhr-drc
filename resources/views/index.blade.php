                        ...
                        <div class="twm-bnr-right-content">
                            ...
                            <div class="twm-bnr-right-carousel">
                                <div class="owl-carousel twm-h1-bnr-carousal">
                                    <div class="item">
                                        <div class="slide-img">
                                            <img src="{{ url('images/main-slider/slider1/r-img1.png') }}"
                                                alt="#">
                                        </div>
                                    </div>
                                    <div class="item">
                                        <div class="slide-img">
                                            <div class="slide-img">
                                                <img src="{{ url('images/main-slider/slider1/r-img2.png') }}"
                                                    alt="#">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="item">
                                    ...
                                    <div class="blog-post twm-blog-post-1-outer">
                                        <div class="wt-post-media">
                                            <a href="#"><img src="{{ url('images/blog/latest/bg1.jpg') }}"
                                                    alt></a>
                                        </div>
                                        <div class="wt-post-info">
                                            <div class="wt-post-meta ">
                                                <ul>
                                                    <li class="post-date">March
                                                        05,
                                                        2023</li>
