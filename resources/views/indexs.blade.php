            ...
            <div class="sticky-header main-bar-wraper navbar-expand-lg">
                <div class="main-bar">
                    <div class="clearfix container-fluid">
                        ...
                        <div class="gap-2 extra-nav header-2-nav">
                            <div style="margin-right: 15px; margin-top: 15px">
                                ...
                                <div class="dropdown">
                                    <button class="p-0 rounded-circle d-flex justify-content-center align-items-center" type="button" data-bs-toggle="dropdown">
                                    ...
                                    <div class="dropdown-menu to-top dropdown-menu-xl" >
                                        <div class="p-2 mb-2 bg-light">
                                            <h6 class="mb-0 text-lg fw-semibold">
                                                Choisissez votre langue
                                            </h6>
                                        </div>

                                        <div class="overflow-y-auto scroll-sm">
                            ...
                            <div class="extra-cell">
                                <div class="header-nav-btn-section">
                                    <div class="twm-nav-btn-left">
                                        <a class="p-2 twm-nav-sign-up" href="{{ route('register.view') }}">
                                    ...
                                    <div class="twm-nav-btn-right">
                                        <a href="{{ route('login.view') }}" class="p-2 btn twm-nav-post-a-job">
