...
class DefaultOptionsCalendar {
    constructor() {
        ...
        (__publicField(this, "isInit", !1),
            ...
            __publicField(this, "locale", { months: [], weekday: [] }),
...
const getDateString = (e) =>
    ...
    messages = {
        ...
        incorrectTheme:
            'Incorrect name of theme in "settings.visibility.theme".',
        incorrectTime:
    ...
    initRange = (e) => {
        ...
        ((e.settings.range.min =
            getDate(e.date.min) >= getDate(e.settings.range.min)
                ? e.date.min
                : e.settings.range.min),
            (e.settings.range.max =
                getDate(e.date.max) <= getDate(e.settings.range.max)
                    ? e.date.max
                    : e.settings.range.max));
        const s =
            e.settings.range.disablePast &&
            !e.settings.range.disableAllDays &&
            getDate(e.settings.range.min) < e.date.today;
        ((e.rangeMin = s
            ? getDateString(e.date.today)
            : e.settings.range.disableAllDays
              ? getDateString(new Date(e.selectedYear, e.selectedMonth, 1))
              : e.settings.range.min),
    ...
    initSelectedDates = (e) => {
        ...
        ((e.selectedDates = (
            ...
            ? parseDates(e.settings.selected.dates)
            : []),
            (e.selectedHolidays = (
                null == (a = e.settings.selected.holidays) ? void 0 : a[0]
            )
                ? parseDates(e.settings.selected.holidays)
                : []));
    },
    initDateMinMax = (e) => {
    ...
    initTime = (e) => {
        ...
        if (t || 24 === e.settings.selection.time) {
            ...
            (!a && t
                ? ((e.selectedHours = transformTime12(
                      String(e.date.today.getHours()),
                  )),
    ...
    visibilityArrows = (e) => {
        ...
        ({
            default: () => {
                const t = getDate(
                        getDateString(
                            new Date(e.selectedYear, e.selectedMonth, 1),
                        ),
                    ),
    ...
    createPopup = (e, t) => {
        ...
        e.popups &&
            (null == (a = Object.entries(e.popups)) ||
                a.forEach(([a, n]) =>
                    handleDay(a, n, t, e.CSSClasses.dayPopup),
                ));
    },
    createWeekNumber = (e, t, a, n, s) => {
        const l = t[a].querySelector(`.${e.CSSClasses.dayBtn}`),
            r = getWeekNumber(
                null == l ? void 0 : l.dataset.calendarDay,
                e.settings.iso8601,
            );
        if (!r) return;
    ...
    createWeekNumbers = (e, t, a, n, s) => {
        ...
        const d = s.querySelectorAll(`.${e.CSSClasses.day}`),
            c = Math.ceil((t + a) / 7);
        for (let t = 0; t < c; t++)
            createWeekNumber(e, d, 0 === t ? 6 : 7 * t, i, r);
    },
    ...
    setDayModifier = (e, t, a, n, s, l, r) => {
        ...
        ((getDate(e.rangeMin) > getDate(l) ||
            ...
            (null == (c = e.selectedDates) ? void 0 : c.includes(l)) &&
                ...
                e.selectedDates.length > 1 &&
                    ...
                    e.selectedDates[0] !== l &&
                        e.selectedDates[e.selectedDates.length - 1] !== l &&
                        a.classList.add(
                            e.CSSClasses.daySelectedIntermediate,
                        ))));
    },
    createDay = (e, t, a, n, s, l, r, i) => {
        ...
        ((c.className = `${e.CSSClasses.dayBtn}${i ? ` ${i}` : ""}`),
            (c.type = "button"),
        ...
        (e.settings.visibility.weekNumbers &&
            ...
            r ? e.settings.visibility.daysOutside && d.append(c) : d.append(c),
            setDisabledDays(e, l, s),
            setDayModifier(e, t, d, c, s, l, r),
            a.append(d),
            e.actions.getDays && e.actions.getDays(n, l, d, c, e));
    },
    prevMonth = (e, t, a, n, s) => {
    ...
    createDays = (e) => {
        ...
        ((e.settings.range.disableAllDays || e.settings.range.disableWeekday) &&
            e.rangeDisabled[0] &&
            (e.rangeDisabled = []),
            t.forEach((t, s) => {
                const l = new Date(n);
                ...
                const r = l.getMonth(),
                    ...
                    o = e.settings.iso8601
                        ? (0 !== d.getDay() ? d.getDay() : 7) - 1
                        : d.getDay();
                (e.settings.selection.day &&
                    t.classList.add(e.CSSClasses.daysSelecting),
                    (t.innerHTML = ""),
                    prevMonth(e, t, i, r, o),
                    currentMonth(e, t, c, i, r),
                    nextMonth(e, t, c, i, r, o),
                    createWeekNumbers(e, o, c, a[s], t),
                    createPopup(e, t));
            }));
    },
    ...
    visibilityTitle = (e) => {
        ...
        (null == n || n.forEach((t, a) => visibilityMonth(e, t, a, l)),
            null == s || s.forEach((t, a) => visibilityYear(e, t, a, l)));
    },
    changeMonth = (e, t) => {
        const a = getDate(
            getDateString(new Date(e.selectedYear, e.selectedMonth, 1)),
            ...
            c = {
                ...
                multiple: () => {
                    i &&
                        ...
                        a.classList.remove(n.calendarMonth, n.calendarYear),
                        (a.innerHTML = MultipleParser(
                            e,
                            DOMParser(e, s.multiple),
                        )));
                },
                month: () => {
                    "multiple" !== l
                        ? (a.classList.add(n.calendarMonth),
                          ...
                          (a.innerHTML = DOMParser(e, s.month)))
                ...
                year: () => {
                    "multiple" !== l
                        ? (a.classList.add(n.calendarYear),
                          ...
                          (a.innerHTML = DOMParser(e, s.year)))
    ...
    handleClickArrow = (e, t) => {
        ...
        a &&
            (["default", "multiple"].includes(e.currentType)
                ? changeMonth(e, a.dataset.calendarArrow)
                : "year" === e.currentType &&
                  void 0 !== e.viewYear &&
                  ((e.viewYear += { prev: -15, next: 15 }[
                      a.dataset.calendarArrow
                  ]),
                  createYears(e, t.target)),
    ...
    getLocaleWeekday = (e, t) => {
        const a = new Date(0, 0, t).toLocaleString(e.settings.lang, {
            weekday: "short",
        });
        e.locale.weekday.push(capitalizeFirstLetter(a));
    },
    getLocaleMonth = (e, t) => {
        const a = new Date(0, t).toLocaleString(e.settings.lang, {
            month: "long",
        });
    ...
    createMonths = (e, t) => {
        ...
        for (let t = 0; t < 12; t++) {
            const a = e.locale.months[t],
                n =
                    (t < e.dateMin.getMonth() + relationshipID(e) &&
                        r <= e.dateMin.getFullYear()) ||
                    (t > e.dateMax.getMonth() + relationshipID(e) &&
                        r >= e.dateMax.getFullYear()) ||
                    (t !== s && !d.includes(t));
    ...
    transformTime24 = (e, t) =>
        e && t
            ...
            : "",
    getInputElement = (e, t, a) =>
        e.querySelector(`.${t}${a ? ` input[name="${a}"]` : ""}`),
    ...
    setTime = (e, t, a, n) => {
        (({
            ...
            e.input &&
                ...
                e.actions.changeToInput(t, actionsInput(e), e));
    },
    changeRange = (e, t, a, n, s, l) => {
        t.addEventListener("input", (t) => {
            const r = t.target,
                ...
                d = i < 10 ? `0${i}` : `${i}`;
            if ("hours" !== s || 12 !== l)
                return ((a.value = d), void setTime(e, t, d, s));
            i < l && i > 0
                ? ((a.value = d),
                ...
                : (0 === i
                  ...
                  (a.value = transformTime12(r.value)),
                  setTime(e, t, transformTime12(r.value), s));
        });
    },
    changeInput = (e, t, a, n, s, l) => {
        a.addEventListener("change", (a) => {
            ...
            "hours" === s && 12 === l
                ? r.value && i <= l && i > 0
                    ? ((r.value = d),
                      (t.value = transformTime24(d, e.selectedKeeping)),
                      setTime(e, a, d, s))
                    : r.value && i < 24 && (i > l || 0 === i)
                      ? (0 === i
                            ...
                            : ((e.selectedKeeping = "PM"),
                              (n.innerText = "PM")),
                        (r.value = transformTime12(r.value)),
                        (t.value = d),
                        setTime(e, a, transformTime12(r.value), s))
                      : (r.value = e.selectedHours)
                : r.value && i <= l && i >= 0
                  ? ((r.value = d), (t.value = d), setTime(e, a, d, s))
                  : "hours" === s
                    ? (r.value = e.selectedHours)
    ...
    clickBtnKeepingTime = (e, t, a) => {
        t.addEventListener("click", (n) => {
            ((e.selectedKeeping = t.innerText.includes("AM") ? "PM" : "AM"),
                ...
                (a.value = transformTime24(e.selectedHours, e.selectedKeeping)),
                setTime(e, n, e.selectedHours, "hours"));
        });
    },
    changeTime = (e, t, a) => {
        ...
        (addMouseEvents(s, r, e.CSSClasses.isFocus),
            addMouseEvents(l, i, e.CSSClasses.isFocus),
            changeRange(e, s, r, d, "hours", n),
            changeRange(e, l, i, d, "minutes", 0),
            changeInput(e, s, r, d, "hours", n),
            changeInput(e, l, i, d, "minutes", 59),
            d && clickBtnKeepingTime(e, d, s));
    },
    InputTime = (e, t, a, n) =>
        `<label class="${t}"><input type="text"name="${e}"maxlength="2"value="${a}"${n ? "disabled" : ""}></label>`,
    RangeTime = (e, t, a, n, s, l) =>
    ...
    createWeekDays = (e, t, a) => {
        ...
        for (let s = 0; s < a.length; s++) {
            ...
            ((r.className = `${e.CSSClasses.weekDay}`),
                (r.className = `${e.CSSClasses.weekDay}${e.settings.visibility.weekend && e.settings.iso8601 ? (5 === s || 6 === s ? ` ${e.CSSClasses.weekDayWeekend}` : "") : e.settings.visibility.weekend && !e.settings.iso8601 && (0 === s || 6 === s) ? ` ${e.CSSClasses.weekDayWeekend}` : ""}`),
                (r.innerText = `${l}`),
                t.append(r));
        }
    },
    ...
    trackChangesThemeInSystemSettings = (e, t) => {
        ...
        (a(t),
            "system" !== e.settings.visibility.theme ||
                haveListener.check() ||
                (t.addEventListener("change", a), haveListener.set()));
    },
    ...
    detectTheme = (e, t) => {
        ...
        if (a) {
            const n = e.settings.visibility.themeDetect.replace(
                ...
                s = getTheme(a, n);
            s
                ? (setTheme(e.HTMLElement, s),
                  trackChangesThemeInHTMLElement(e, a, n))
                : trackChangesThemeInSystemSettings(e, t);
    ...
    current = { self: null, rangeMin: void 0, rangeMax: void 0 },
    removeHoverEffect = () => {
        var e;
        if (!(null == (e = current.self) ? void 0 : e.HTMLElement)) return;
        const { CSSClasses: t } = current.self;
        current.self.HTMLElement.querySelectorAll(
            `.${current.self.CSSClasses.dayBtnHover}`,
        ).forEach((e) => {
            var a;
            (e.classList.remove(current.self.CSSClasses.dayBtnHover),
    ...
    addHoverEffect = (e, t, a) => {
        ...
        const r = getDateString(e),
            { CSSClasses: i } = current.self;
        if (null == (s = current.self.rangeDisabled) ? void 0 : s.includes(r))
            return;
        const d =
            null == (l = current.self.HTMLElement)
                ? void 0
    ...
    handleHoverDaysEvent = (e) => {
        ...
        if (
            !e.target ||
            !(null == (t = current.self) ? void 0 : t.selectedDates)
        )
            return;
        ...
        const n = a.dataset.calendarDay,
            ...
            l = getDate(n),
            r = current.self.HTMLElement.querySelectorAll(
                `[data-calendar-day="${current.self.selectedDates[0]}"]`,
            ),
            i = current.self.HTMLElement.querySelectorAll(
                `[data-calendar-day="${n}"]`,
            ),
            [d, c] = s < l ? [r, i] : [i, r],
            [o, u] = s < l ? [s, l] : [l, s];
        removeHoverEffect();
        for (let e = new Date(o); e <= u; e.setDate(e.getDate() + 1))
            addHoverEffect(e, d, c);
    },
    handleCancelSelectionDays = (e) => {
        current.self &&
            "Escape" === e.key &&
            ((current.self.selectedDates = []),
            current.self.HTMLElement.removeEventListener(
                "mousemove",
                handleHoverDaysEvent,
            ),
    ...
    updateDisabledDates = () => {
        ...
        if (
            !(null ==
            (t = null == (e = current.self) ? void 0 : e.selectedDates)
                ? void 0
                : t[0]) ||
            !current.self.rangeDisabled ||
            (null == (a = current.self.rangeDisabled) ? void 0 : a.length) < 2
        )
            return;
        const n = getDate(current.self.selectedDates[0]),
            [s, l] = current.self.rangeDisabled
                .map((e) => getDate(e))
                .reduce(
                    ([e, t], a) => [
                        n >= a ? a : e,
        ...
        (s &&
            (current.self.rangeMin = getDateString(
                new Date(s.setDate(s.getDate() + 1)),
            )),
            l &&
                (current.self.rangeMax = getDateString(
    ...
    handleDayRangedSelection = (e, t) => {
        ...
        (e.settings.range.disableGaps &&
            ((current.rangeMin = current.rangeMin
                ? current.rangeMin
                : e.rangeMin),
            (current.rangeMax = current.rangeMax
                ? current.rangeMax
                : e.rangeMax)),
            (current.self = e));
        ({
    ...
    handleClickDay = (e, t) => {
        ...
        (({
            ...
            "multiple-ranged": () =>
                handleDayRangedSelection(e, l.dataset.calendarDay),
        })[e.settings.selection.day](),
            null == (a = e.selectedDates) ||
                a.sort((e, t) => +new Date(e) - +new Date(t)),
    ...
    handleClickMonthOrYear = (e, t, a, n) => {
        ...
        if (e.currentType !== a && r) {
            ...
            i
                ? handleItemClick(e, t, a, n, i)
                : ((e.currentType === a && r) ||
                      ("multiple" === e.type &&
                          e.currentType === a &&
                          d &&
                          !c)) &&
                  ((e.currentType = e.type), create(e));
    },
    handleClick = (e) => {
        e.HTMLElement.addEventListener("click", (t) => {
            (handleClickArrow(e, t),
                handleClickWeekNumber(e, t),
                handleClickDay(e, t),
                handleClickMonthOrYear(e, t, "month", {
    ...
    update = (
        e,
        { year: t, month: a, dates: n, holidays: s, time: l } = {},
    ) => {
        var r;
        if (!e.isInit) throw new Error(messages.notInit);
        const i = __spreadValues({}, e.settings.selected);
        ((e.settings.selected.year = t ? i.year : e.selectedYear),
            (e.settings.selected.month = a ? i.month : e.selectedMonth),
            (e.settings.selected.holidays = s
                ? i.holidays
                : e.selectedHolidays),
            (e.settings.selected.time = l ? i.time : e.selectedTime),
            (e.settings.selected.dates =
                "only-first" === n &&
                (null == (r = e.selectedDates) ? void 0 : r[0])
                    ? [e.selectedDates[0]]
                    : !0 === n
                      ? i.dates
                      : e.selectedDates),
            setVariables(e),
            create(e),
            (e.settings.selected = i),
            "multiple-ranged" === e.settings.selection.day &&
                n &&
                handleDayRangedSelection(e));
    },
    setPositionCalendar = (e, t, a) => {
        ...
        for (let t = e; t; t = t.offsetParent)
            ((s += t.offsetTop || 0), (l += t.offsetLeft || 0));
            ...
            (t
                ? (() => {
                      ...
                      ((a.className = `${e.CSSClasses.calendar} ${e.CSSClasses.calendarToInput} ${e.CSSClasses.calendarHidden}`),
                          ...
                          (t = !1),
                          setTimeout(() => actionsInput(e).show(), 0),
                          update(e),
                          handleClick(e));
                  })()
                : (setPositionCalendar(
    ...
    init = (e) => {
        ((e.HTMLOriginalElement = e.HTMLElement.cloneNode(!0)),
            ...
            e.input
                ? handleInput(e)
                : (setVariables(e), create(e), handleClick(e)));
    },
    destroy = (e) => {
        var t, a, n, s;
        if (!e.isInit) throw new Error(messages.notInit);
    ...
    constructor(e, t) {
        if (
            ...
            __publicField(this, "init", () => {
                return (
                    ((e = this).HTMLOriginalElement =
                        e.HTMLElement.cloneNode(!0)),
                    (e.isInit = !0),
                    void (e.input
                        ? handleInput(e)
                        : (setVariables(e), create(e), handleClick(e)))
            ...
            __publicField(this, "update", (e) => update(this, e)),
